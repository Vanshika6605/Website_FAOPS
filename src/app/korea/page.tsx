...
export default function KoreaPage() {
  return (
    <div data-testid="korea-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Korea.</>}
        intro="Representing the perinatal community of Korea within the East Region."
        crumbs={[
          { label: "Korea" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <h2 className="mt-4 text-3xl font-semibold tracking-tight text-faops-navy md:text-4xl">
          Perinatal Society of Korea
        </h2>

        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Korea is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
