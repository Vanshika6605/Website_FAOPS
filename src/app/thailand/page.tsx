...
export const metadata: Metadata = {
  title: "Thailand | FAOPS",
};

export default function ThailandPage() {
  return (
    <div data-testid="thailand-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Thailand.</>}
        intro="Representing the perinatal community of Thailand within the Central Region."
        crumbs={[
          { label: "Thailand" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Thailand is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
