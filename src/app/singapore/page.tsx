...
export const metadata: Metadata = {
  title: "Singapore | FAOPS",
};

export default function SingaporePage() {
  return (
    <div data-testid="singapore-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Singapore.</>}
        intro="Representing the perinatal community of Singapore within the Central Region."
        crumbs={[
          { label: "Singapore" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Singapore is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
