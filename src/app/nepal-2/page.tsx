...
export default function NepalPage() {
  return (
    <div data-testid="nepal-2-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Nepal.</>}
        intro="Representing the perinatal community of Nepal within the West Region."
        crumbs={[
          { label: "Nepal" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Nepal is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
