...
export const metadata: Metadata = {
  title: "Indonesia | FAOPS",
};

export default function IndonesiaPage() {
  return (
    <div data-testid="indonesia-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Indonesia.</>}
        intro="Representing the perinatal community of Indonesia within the Central Region."
        crumbs={[
          { label: "Indonesia" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <h2 className="mt-4 text-3xl font-semibold tracking-tight text-faops-navy md:text-4xl">
          Perinatal Society of Indonesia
        </h2>

        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Indonesia is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
