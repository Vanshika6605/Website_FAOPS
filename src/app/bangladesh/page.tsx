...
export const metadata: Metadata = {
  title: "Bangladesh | FAOPS",
};

export default function BangladeshPage() {
  return (
    <div data-testid="bangladesh-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Bangladesh.</>}
        intro="Representing the perinatal community of Bangladesh within the West Region."
        crumbs={[
          { label: "Bangladesh" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <h2 className="mt-4 text-3xl font-semibold tracking-tight text-faops-navy md:text-4xl">
          Perinatal Society of Bangladesh
        </h2>

        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Bangladesh is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
