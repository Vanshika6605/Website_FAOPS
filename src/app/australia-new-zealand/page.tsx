...
export const metadata: Metadata = {
  title: "Australia & New Zealand | FAOPS",
};

export default function AustraliaNewZealandPage() {
  return (
    <div data-testid="australia-new-zealand-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Australia & New Zealand.</>}
        intro="Representing the perinatal community of Australia & New Zealand within the Oceania Region."
        crumbs={[
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Australia & New Zealand is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
