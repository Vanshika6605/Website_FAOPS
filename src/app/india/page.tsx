...
export default function IndiaPage() {
  return (
    <div data-testid="india-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>India.</>}
        intro="Representing the perinatal community of India within the West Region."
        crumbs={[
          { label: "India" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <h2 className="mt-4 text-3xl font-semibold tracking-tight text-faops-navy md:text-4xl">
          Perinatal Society of India
        </h2>

        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of India is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
