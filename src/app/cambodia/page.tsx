...
export const metadata: Metadata = {
  title: "Cambodia | FAOPS",
};

export default function CambodiaPage() {
  return (
    <div data-testid="cambodia-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Cambodia.</>}
        intro="Representing the perinatal community of Cambodia within the Central Region."
        crumbs={[
          { label: "Cambodia" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <h2 className="mt-4 text-3xl font-semibold tracking-tight text-faops-navy md:text-4xl">
          Perinatal Society of Cambodia
        </h2>

        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Cambodia is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
