...
export const metadata: Metadata = {
  title: "Sri Lanka | FAOPS",
};

export default function SriLankaPage() {
  return (
    <div data-testid="sri-lanka-page" className="bg-white">
      <PageHeader
        tag="Membership"
        title={<>Sri Lanka.</>}
        intro="Representing the perinatal community of Sri Lanka within the West Region."
        crumbs={[
          { label: "Sri Lanka" },
        ]}
      />
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-faops-secondary">
          <p>
            The national society of Sri Lanka is a proud member of the Federation of Asia-Oceania Perinatal Societies (FAOPS). Working together with the federation, the society aims to advance the science and art of perinatology within the nation.
          </p>
